...
Script:
  ...
  python relevant_courses.py [-h] [degree_reqs] [output]
...
# Generate list of relevant courses from either manual input or JSON input:
def get_relevant_courses(reqs):
	relevant_courses = []
...
if __name__ in '__main__':
	...
	for line in get_relevant_courses(args.degree_reqs):
